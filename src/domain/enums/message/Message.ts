export enum Message {
  ...
  DEPT_MAINT_TYPE_ASSIGNMENT_OBTAINED_SUCCESSFULLY = "COD501",
  ...
  PROCESS_CREATED_SUCCESSFULLY = "COD700",
  PROCESSES_OBTAINED_SUCCESSFULLY = "COD701",

  COORDINATOR_ALREADY_EXISTS = "COD800",
  NOT_COORDINATOR_FOUND = "COD801",

  BAD_REQUEST = "COD900",
  INTERNAL_SERVER_ERROR = "COD999",
}
