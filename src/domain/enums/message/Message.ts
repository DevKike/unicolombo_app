export enum Message {
  ...
  TEMPLATE_FILE_UPLOADED_SUCCESSFULLY = "COD_800",
  TEMPLATE_FORM_SAVED_SUCCESSFULLY = "COD_801",

  COORDINATOR_ALREADY_EXISTS = "COD900",
  NOT_COORDINATOR_FOUND = "COD901",

  INVALID_FILE_FORMAT = "COD902",
  INVALID_FILE_TYPE = "COD903",
  NOT_FILE_EXTENSION_ALLOWED = "COD904",
