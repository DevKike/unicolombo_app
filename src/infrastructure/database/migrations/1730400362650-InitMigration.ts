...
export class InitMigration1730400362650 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`form\` (\`id\` int NOT NULL AUTO_INCREMENT, \`code\` int NOT NULL, \`name\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`path\` varchar(255) NOT NULL, \`extension\` varchar(255) NOT NULL, \`registered_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`stage_id\` int NULL, UNIQUE INDEX \`IDX_6de099a275bb4e9efc460b3127\` (\`code\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`form\` ADD CONSTRAINT \`FK_e1047fb2b4515638f1ea848d2dd\` FOREIGN KEY (\`stage_id\`) REFERENCES \`stage\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`form\` DROP FOREIGN KEY \`FK_e1047fb2b4515638f1ea848d2dd\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_6de099a275bb4e9efc460b3127\` ON \`form\``);
