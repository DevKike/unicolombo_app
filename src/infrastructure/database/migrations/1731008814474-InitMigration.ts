...
export class InitMigration1731008814474 implements MigrationInterface {
    name = 'InitMigration1731008814474'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`template_form\` (\`id\` int NOT NULL AUTO_INCREMENT, \`code\` varchar(255) NOT NULL, \`name\` varchar(255) NOT NULL, \`description\` varchar(255) NULL, \`filePath\` varchar(255) NOT NULL, \`fileExtension\` varchar(255) NOT NULL, \`registered_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`stage_id\` int NULL, UNIQUE INDEX \`IDX_b4b361ca5b3cffd5098aba7d1e\` (\`code\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
