...
export class TemplateFormRouter implements IRouterModule {
  ...
  initRoutes(): void {
    this.templateFormRouter.post("/", authMiddleware(), schemaValidator(saveTemplateFormSchema), async (req, res) => {
    ...
    this.templateFormRouter.get("/", authMiddleware(), async (req, res) => {
    ...
    this.templateFormRouter.get("/:id", authMiddleware(), async (req, res) => {
    ...
    this.templateFormRouter.get("/by-stage/:stageId", authMiddleware(), async (req, res) => {
    ...
    this.templateFormRouter.patch("/:id", authMiddleware(), schemaValidator(updateTemplateFormSchema), async (req, res) => {
