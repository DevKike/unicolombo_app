...
export class Environment {
  ...
  static readonly AUTH_EMAIL = process?.env.SYSTEM_COORDINATOR_EMAIL  || "admin@unicolombo.edu.co";
  static readonly AUTH_PASSWORD = process?.env.SYSTEM_COORDINATOR_PASSWORD || "admin123";
